      ...
      >
        ...
        <div className="space-y-4 mb-8 text-left">
          <p className="text-gray-700">
            ...
            will ship it soon. A confirmation Email with your order dtails will
            be send to you shortly
          </p>
          <p className="text-gray-700">
            Order Number :{" "}
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-8">
          ...
          <ul className="text-gray-700 text-sm space-y-1">
            <li>Check your mail for order confirmation</li>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <Link
            ...
            className="flex items-center justify-center px-4 py-3 font-semibold bg-black
             text-white rounded-lg hover:bg-gray-800 transition-all duration-300 shadow-md"
          >
          ...
          <Link
            href={"/orders"}
            className="flex items-center justify-center px-4 py-3 font-semibold bg-white
             text-black border border-black rounded-lg hover:bg-gray-100 transition-all duration-300 shadow-md"
          >
