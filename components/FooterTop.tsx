...
const Data: Props[] = [
...

  {
    ...
    icon: (
      <Clock className="text-gray-600 group-hover:text-black transition-colors" />
    ),
  },

  {
    title: "Email Us",
    subtitle: "clothswear@gmail.com",
    icon: (
      <Mail className="text-gray-600 group-hover:text-black transition-colors" />
    ),
  },
];
